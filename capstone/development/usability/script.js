(function(){
    'use strict';
    alert("Hi! Please complete the following task as you explore through the page:\n1. View the persona's experience from the Medieval Time. \n2. View the persona's experience from the present time. \n3. Answer the questions from 'What would you do' questions.");
    AOS.init();
